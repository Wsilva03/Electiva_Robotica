...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Contorno = QtWidgets.QPushButton(self.centralwidget)
        self.Contorno.setGeometry(QtCore.QRect(280, 10, 101, 41))
        self.Contorno.setObjectName("Contorno")
        ...
        self.Contorno.clicked.connect(self.detectar_contornos)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Contorno.setText(_translate("MainWindow", "Contorno"))
